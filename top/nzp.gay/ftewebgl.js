...
function createWasm() {
    ...
    function receiveInstance(instance, module) {
        ...
        Module["asm"] = exports;
        wasmMemory = Module["asm"]["pc"];
        updateGlobalBufferAndViews(wasmMemory.buffer);
        wasmTable = Module["asm"]["rc"];
        addOnInit(Module["asm"]["qc"]);
...
var FTEC = {
    ...
    step: function(timestamp) {
        ...
        if (FTEC.aborted)
            return;
        try {
            dovsync = getWasmTableEntry(FTEC.evcb.frame)(timestamp)
        } catch (err) {
            console.log(err)
        }
        if (dovsync)
    ...
    handleevent: function(event) {
        ...
        case "keyup":
            if (FTEC.evcb.key != 0 && event.keyCode != 122) {
                var codepoint = event.key.codePointAt(1) ? 0 : event.key.codePointAt(0);
                if (codepoint < " ")
                    codepoint = 0;
...
function _emscriptenfte_setupcanvas(nw, nh, evresize, evmouse, evmbutton, evkey, evfile, evcbufadd, evjbutton, evjaxis, evwantfullscreen) {
    try {
        ...
        if (!FTEC.donecb) {
            ...
            var docevents = ["keypress", "keydown", "keyup", "pointerlockerror", "pointerlockchange", "mozpointerlockchange", "webkitpointerlockchange"];
...
var asmLibraryArg = {
    "X": _Sys_Clipboard_PasteText,
    "o": _Sys_SaveClipboard,
    "zb": ___syscall_getuid32,
    "Cb": __gmtime_js,
    "Db": __localtime_js,
    "Eb": __mktime_js,
    "Fb": __tzset_js,
    ...
    "W": _alGetString,
    "ac": _alIsBuffer,
    "Wa": _alIsExtensionPresent,
    "Ta": _alIsSource,
    "bc": _alListenerf,
    "V": _alListenerfv,
    "Ua": _alSourcePlay,
    "U": _alSourceQueueBuffers,
    "Sa": _alSourceStop,
    "Va": _alSourceUnqueueBuffers,
    "n": _alSourcef,
    "Ra": _alSourcefv,
    "v": _alSourcei,
    "Pb": _alcCaptureCloseDevice,
    "Qb": _alcCaptureOpenDevice,
    "Mb": _alcCaptureSamples,
    "Ob": _alcCaptureStart,
    "Nb": _alcCaptureStop,
    "ra": _alcCloseDevice,
    "Xa": _alcCreateContext,
    "_a": _alcDestroyContext,
    "Tb": _alcGetContextsDevice,
    "Ub": _alcGetCurrentContext,
    "Rb": _alcGetEnumValue,
    "Sb": _alcGetError,
    "qa": _alcGetIntegerv,
    "B": _alcGetString,
    "Ya": _alcIsExtensionPresent,
    "sa": _alcMakeContextCurrent,
    "Za": _alcOpenDevice,
    "Wb": _alcProcessContext,
    "Vb": _alcSuspendContext,
    "Qa": _clock,
    "Lb": _emscripten_alcDevicePauseSOFT,
    "Kb": _emscripten_alcDeviceResumeSOFT,
    "Jb": _emscripten_alcGetStringiSOFT,
    "Ib": _emscripten_alcResetDeviceSOFT,
    "Xb": _emscripten_asm_const_int,
    "Hb": _emscripten_console_error,
    "Pa": _emscripten_get_now,
    "Gb": _emscripten_memcpy_big,
    "yb": _emscripten_resize_heap,
    "Yb": _emscripten_run_script_string,
    "O": _emscriptenfte_abortmainloop,
    "_b": _emscriptenfte_al_loadaudiofile,
    "bb": _emscriptenfte_alert,
    "cb": _emscriptenfte_async_wget_data2,
    "Y": _emscriptenfte_buf_create,
    "mc": _emscriptenfte_buf_delete,
    "ec": _emscriptenfte_buf_getsize,
    "dc": _emscriptenfte_buf_open,
    "cc": _emscriptenfte_buf_pushtolocalstore,
    "gc": _emscriptenfte_buf_read,
    "hc": _emscriptenfte_buf_release,
    "lc": _emscriptenfte_buf_rename,
    "fc": _emscriptenfte_buf_write,
    "xb": _emscriptenfte_gl_loadtexturefile,
    "eb": _emscriptenfte_polljoyevents,
    "ab": _emscriptenfte_print,
    "ua": _emscriptenfte_rtc_candidate,
    "db": _emscriptenfte_rtc_create,
    "va": _emscriptenfte_rtc_offer,
    "gb": _emscriptenfte_settitle,
    "xa": _emscriptenfte_setupcanvas,
    "ic": _emscriptenfte_setupmainloop,
    "fb": _emscriptenfte_updatepointerlock,
    "nc": _emscriptenfte_uptime_ms,
    "jc": _emscriptenfte_window_location,
    "z": _emscriptenfte_ws_close,
    "wa": _emscriptenfte_ws_connect,
    "Z": _emscriptenfte_ws_recv,
    "I": _emscriptenfte_ws_send,
    "kc": _emscritenfte_buf_enumerate,
    "Ab": _environ_get,
    ...
    "Na": _glCompressedTexSubImage2D,
    "ba": _glCopyTexImage2D,
...
var ___wasm_call_ctors = Module["___wasm_call_ctors"] = function() {
    return (___wasm_call_ctors = Module["___wasm_call_ctors"] = Module["asm"]["qc"]).apply(null, arguments)
}
;
var _malloc = Module["_malloc"] = function() {
    return (_malloc = Module["_malloc"] = Module["asm"]["sc"]).apply(null, arguments)
}
;
var _main = Module["_main"] = function() {
    return (_main = Module["_main"] = Module["asm"]["tc"]).apply(null, arguments)
}
;
var _emscripten_builtin_malloc = Module["_emscripten_builtin_malloc"] = function() {
    return (_emscripten_builtin_malloc = Module["_emscripten_builtin_malloc"] = Module["asm"]["uc"]).apply(null, arguments)
}
;
var _emscripten_builtin_free = Module["_emscripten_builtin_free"] = function() {
    return (_emscripten_builtin_free = Module["_emscripten_builtin_free"] = Module["asm"]["vc"]).apply(null, arguments)
}
;
